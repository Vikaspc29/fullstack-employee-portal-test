...
function parser(document) {
  ...
  invariant(!fragments.length || queries.length || mutations.length || subscriptions.length, 96);
  invariant(
...
function useFragment_(options) {
  ...
  var diff = React17.useMemo(function() {
    ...
    var diff2 = muteDeprecations("canonizeResults", function() {
      return cache3.diff(__assign(__assign({}, stableOptions), { returnPartialData: true, id: from2, query: cache3["getFragmentDoc"](fragment, fragmentName), optimistic }));
    });
    return {
...
var FragmentReference = (
  ...
  (function() {
    ...
    FragmentReference2.prototype.getDiff = function(client, options) {
      ...
      var diff = cache2.diff(__assign(__assign({}, options), { query: cache2["getFragmentDoc"](fragment, fragmentName), returnPartialData: true, id: from, optimistic: true }));
...
//# sourceMappingURL=chunk-6W3TKLRV.js.map
